...
lv_obj_t * ui_percent_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_height(cui_percent, 25);
    lv_obj_set_width(cui_percent, LV_SIZE_CONTENT);   /// 60
    ...
    lv_obj_set_x(cui_percent_label, -1);
    lv_obj_set_y(cui_percent_label, -1);
    ...
    lv_obj_set_style_text_font(cui_percent_label, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_t * cui_corner;
    cui_corner = lv_obj_create(cui_percent);
    lv_obj_set_width(cui_corner, 12);
    lv_obj_set_height(cui_corner, 12);
