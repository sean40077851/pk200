...
lv_obj_t * ui_button_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_width(cui_button, 116);
    lv_obj_set_height(cui_button, 28);
    lv_obj_set_x(cui_button, 21);
    lv_obj_set_y(cui_button, 22);
    ...
    lv_obj_set_style_shadow_width(cui_button, 18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_ofs_y(cui_button, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(cui_button, 18, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(cui_button, 18, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(cui_button, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(cui_button, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_button_label, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
